...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeRequests().antMatchers("/**/oauth/token").permitAll()
				...
				.antMatchers("/**/all-users/").permitAll().antMatchers("/**/all-recomandation-blog/").permitAll()
				...
				.antMatchers("/**/location/").permitAll().antMatchers("/**/user/{id}").permitAll().antMatchers("/**/all-user/").permitAll()
