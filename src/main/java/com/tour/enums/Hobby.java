...
public enum Hobby {
	...
	PHOTOGRAPHY("Photography"), READINGnWRINTING("Reading/Writing"), TREKKING("Trekking"), MEDITATIONnYOGA("Meditation/Yoga"), DANCING("Dancing"), FOODING("Fooding"), OTHER("Other");
